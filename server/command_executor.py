...
class CommandExecutor:
    ...
    def execute(self, cmd: BaseCommand):
        ...
        try:
            ...
            self._logger.error(
                f"Error executing {cmd} with context: {cmd.context}. Exception: {e}"
            )
